        ...
        <div id="header">
            <div class="wrapper">
                <a href="index.html" class="logo">
                    <img src="style/images/logo.png" width="229" height="43" alt="专注京津冀IT招聘" />
                </a>
...
<?php elseif($user_data['user_type']==0):?>
                <dl class="collapsible_menu">
					<dt>
						<span id='nowrap'><?php echo $user_data['user_name']?>&nbsp;</span> 
					...
					<dd class="logout"><a rel="nofollow" href="logout.html">退出</a></dd>
				</dl>
<?php else:?>				
				<dl class="collapsible_menu">
                    <dt>
...
<div class="hot_pos_l">
<div class="mb10">
<a href="jobdetail.html" target="_blank">内容运营（未登录）</a> 
&nbsp;
...
<div class="hot_pos_l">
<div class="mb10">
<a href="jobdetail1.html" target="_blank">WEB前端开发（已登录）</a> 
&nbsp;
<span class="c9">[北京]</span>
</div>
