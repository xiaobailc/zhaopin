...
CREATE TABLE IF NOT EXISTS `zp_ad` (
...
CREATE TABLE IF NOT EXISTS `zp_adclick` (
...
--
-- 表的结构 `zp_admin_announcement`
--

CREATE TABLE IF NOT EXISTS `zp_admin_announcement` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zp_admin_config`
--

CREATE TABLE IF NOT EXISTS `zp_admin_config` (
...
CREATE TABLE IF NOT EXISTS `zp_admin_link` (
...
--
-- 表的结构 `zp_admin_navigation`
--

CREATE TABLE IF NOT EXISTS `zp_admin_navigation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zp_admin_template`
--

CREATE TABLE IF NOT EXISTS `zp_admin_template` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_admin_user` (
...
--
-- 表的结构 `zp_admin_user_group`
--

CREATE TABLE IF NOT EXISTS `zp_admin_user_group` (
...
CREATE TABLE IF NOT EXISTS `zp_ad_class` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_answer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `qid` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
...
--
-- 表的结构 `zp_answer_review`
--

CREATE TABLE IF NOT EXISTS `zp_answer_review` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_atn` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_attention` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ids` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_bank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_change` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_city_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_comclass` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_company` (
  `uid` int(11) NOT NULL,
...
--
-- 表的结构 `zp_company_cert`
--

CREATE TABLE IF NOT EXISTS `zp_company_cert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_company_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `hy` int(5) DEFAULT NULL,
...
--
-- 表的结构 `zp_company_job_link`
--

CREATE TABLE IF NOT EXISTS `zp_company_job_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_company_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `zp_company_news`
--

CREATE TABLE IF NOT EXISTS `zp_company_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zp_company_order`
--

CREATE TABLE IF NOT EXISTS `zp_company_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_company_pay` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` varchar(18) DEFAULT NULL,
...
--
-- 表的结构 `zp_company_product`
--

CREATE TABLE IF NOT EXISTS `zp_company_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `title` varchar(200) DEFAULT '0',
...
--
-- 表的结构 `zp_company_rating`
--

CREATE TABLE IF NOT EXISTS `zp_company_rating` (
...
--
-- 表的结构 `zp_company_show`
--

CREATE TABLE IF NOT EXISTS `zp_company_show` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zp_company_statis`
--

CREATE TABLE IF NOT EXISTS `zp_company_statis` (
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_company_tpl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_cron` (
...
CREATE TABLE IF NOT EXISTS `zp_description` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_desc_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `sort` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `zp_domain` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_down_resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_email_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_fav_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_finder` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `usertype` int(1) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_friend` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `nid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_friend_foot` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_friend_info` (
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `zp_friend_message`
--

CREATE TABLE IF NOT EXISTS `zp_friend_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `zp_friend_reply`
--

CREATE TABLE IF NOT EXISTS `zp_friend_reply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nid` int(11) DEFAULT NULL,
  `fid` int(11) DEFAULT NULL,
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `zp_friend_state`
--

CREATE TABLE IF NOT EXISTS `zp_friend_state` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `content` varchar(225) CHARACTER SET gbk  DEFAULT NULL,
  `ctime` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_hotjob` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_hot_key` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_industry` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `sort` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `zp_job_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_look_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `jobid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_look_resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `com_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_member` (
...
CREATE TABLE IF NOT EXISTS `zp_member_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `zp_member_statis`
--

CREATE TABLE IF NOT EXISTS `zp_member_statis` (
  `uid` int(11) NOT NULL,
  `integral` varchar(10) NOT NULL DEFAULT '0',
  `pay` double(10,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `zp_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_moblie_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
  `cuid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_navigation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
...
--
-- 表的结构 `zp_navigation_type`
--

CREATE TABLE IF NOT EXISTS `zp_navigation_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_navmap` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `url` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_news_base` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nid` int(11) NOT NULL,
...
--
-- 表的结构 `zp_news_content`
--

CREATE TABLE IF NOT EXISTS `zp_news_content` (
...
CREATE TABLE IF NOT EXISTS `zp_news_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `sort` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `zp_once_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_outside` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_property` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_question` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` text NOT NULL,
  `content` text NOT NULL,
  `cid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_q_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `pid` int(11) NOT NULL,
  `pic` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_reason` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `zp_report` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `p_uid` int(11) DEFAULT NULL,
  `c_uid` int(11) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_resume_cert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_resume_doc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `doc` text,
...
--
-- 表的结构 `zp_resume_expect`
--

CREATE TABLE IF NOT EXISTS `zp_resume_expect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `name` varchar(25) DEFAULT NULL,
  `hy` int(5) DEFAULT NULL,
...
--
-- 表的结构 `zp_resume_other`
--

CREATE TABLE IF NOT EXISTS `zp_resume_other` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `title` varchar(50) DEFAULT NULL,
...
--
-- 表的结构 `zp_resume_project`
--

CREATE TABLE IF NOT EXISTS `zp_resume_project` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_resume_show` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) CHARACTER SET gbk  DEFAULT NULL,
  `picurl` varchar(200) CHARACTER SET gbk  DEFAULT NULL,
  `ctime` varchar(200) CHARACTER SET gbk  DEFAULT NULL,
...
--
-- 表的结构 `zp_resume_skill`
--

CREATE TABLE IF NOT EXISTS `zp_resume_skill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_resume_tiny` (
...
--
-- 表的结构 `zp_resume_training`
--

CREATE TABLE IF NOT EXISTS `zp_resume_training` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_reward` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zp_reward_class`
--

CREATE TABLE IF NOT EXISTS `zp_reward_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_seo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_subscribe` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `email` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_sysmsg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_talent_pool` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
  `cuid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_templates` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `content` text,
...
--
-- 表的结构 `zp_toolbox_class`
--

CREATE TABLE IF NOT EXISTS `zp_toolbox_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_toolbox_doc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_userclass` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_userid_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_userid_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_user_resume` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL,
  `eid` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_warning` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `type` int(1) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_website` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `zp_wxlog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zp_wxnav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zp_zhaopinhui` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) DEFAULT '0',
  `pic` varchar(200) DEFAULT '0',
...
--
-- 表的结构 `zp_zhaopinhui_com`
--

CREATE TABLE IF NOT EXISTS `zp_zhaopinhui_com` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
...
--
-- 表的结构 `zp_zhaopinhui_pic`
--

CREATE TABLE IF NOT EXISTS `zp_zhaopinhui_pic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) DEFAULT '0',
  `pic` varchar(200) DEFAULT '0',
  `sort` int(11) DEFAULT '0',
